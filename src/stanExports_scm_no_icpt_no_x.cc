...
#include "stanExports_scm_no_icpt_no_x.h"

RCPP_MODULE(stan_fit4scm_no_icpt_no_x_mod) {


    class_<rstan::stan_fit<stan_model, stan::rng_t> >("rstantools_model_scm_no_icpt_no_x")
