...
#include "stanExports_scm_tv_icpt_tv_x.h"

RCPP_MODULE(stan_fit4scm_tv_icpt_tv_x_mod) {


    class_<rstan::stan_fit<stan_model, stan::rng_t> >("rstantools_model_scm_tv_icpt_tv_x")
