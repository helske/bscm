...
test_that("bscmfit$setup values are correct", {
  ...
  expect_equal(fit1_int$setup$model_type, "bscm_a1_x0_w0_dr")
  expect_equal(fit1_noint$setup$model_type, "bscm_a0_x0_w0_dr")
  expect_equal(fit1_x$setup$model_type, "bscm_a1_x1_w0_dr")
  expect_equal(fitN_xz$setup$model_type, "bscm_a1_x1_w0_dr")
  expect_equal(get_treated(fitN_xz), c("1", "2", "3"))
})

test_that("bscmfit$setup with tv() has correct structure", {
  setup <- fitN_tv$setup
  expect_equal(setup$model_type, "bscm_a1_x1_w1_dr")
